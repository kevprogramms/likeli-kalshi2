                ...
                <div className="vault-positions glass">
                    ...
                    <div className="positions-list">
                        {vault.positions.map(pos => {
                            const pnl = pos.unrealizedPnl || ((pos.currentPrice - pos.avgPrice) * pos.shares)
                            ...
                            return (
                                <div key={pos.id} className="position-item">
                                    ...
                                    <div className="position-details">
                                        ...
                                        <span className="position-cost">Cost: {formatCurrency(pos.costBasis)}</span>
                                        <span className="position-price">@{(pos.avgPrice * 100).toFixed(0)}¢</span>
            ...
            {vault.trades && vault.trades.length > 0 && (
                <div className="vault-trades glass">
                    ...
                    <div className="trades-list">
                        {vault.trades.slice(-5).reverse().map(trade => (
                            <div key={trade.id} className="trade-item">
                                <span className={`trade-side ${trade.side.toLowerCase()}`}>{trade.side}</span>
                                <span className="trade-market">{trade.marketName}</span>
